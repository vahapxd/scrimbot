...
module.exports = {
    ...
    execute: async (client, message, args, anan, author, channel, guild) => {
        ...
        let embed = new MessageEmbed().setColor('#2F3136').setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true })).setColor('RED').setFooter("Vahap was here!")
