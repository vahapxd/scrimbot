  ...
  files.forEach(f => {
    readdir("./src/commands/" + f, (err2, files2) => {
      ...
      files2.forEach(file => {
        ...
        console.log(`[VAHAP-COMMAND] ${prop.name} yüklendi!`);
...
readdir("./src/events", (err, files) => {
  ...
  files.filter((file) => file.endsWith(".js")).forEach((file) => {
    ...
    console.log(`[Vahap-EVENT] ${prop.conf.name} yüklendi!`);
  });
});

client.login("OTcxODE2MTgwNDE3NDMzNjgw.YnQAWA.f6-N2DEqMg8bHS3UOP76pAOVtgI")
